...
fn rotating_a_point_around_the_x_axis() {
    ...
    assert_eq!(half_quarter * p, point(0, SQRT_2 / 2.0, SQRT_2 / 2.0));
...
fn rotating_a_point_around_the_y_axis() {
    ...
    assert_eq!(half_quarter * p, point(SQRT_2 / 2.0, 0, SQRT_2 / 2.0));
...
fn rotating_a_point_around_the_z_axis() {
    ...
    assert_eq!(half_quarter * p, point(-SQRT_2 / 2.0, SQRT_2 / 2.0, 0));
    assert_eq!(full_quarter * p, point(-1, 0, 0));
}
